...
public class ServerRebre implements Runnable {
    ...
    public ServerRebre(Socket socol, DataInputStream entrada, DataOutputStream sortida, String usuari, TextArea txtArea) {
        this.socol = socol;
        ...
        while (true) {
            try {
                ...
                if (!missatge.equals(usuari + ": Fi")){
                    txtArea.appendText("\n"+missatge);
                    for(ServerRebre llista: Server.Clients){
